		...
		<div class="relative flex items-center justify-center">
			...
			>
				...
				<path
					...
					fill="url(#homepage-logo-gradient)"
			...
			<h1 class="relative z-10 text-8xl md:text-9xl text-foreground tracking-tight font-medium font-mono">
				Varsel
				<sub class="absolute -bottom-2 left-1/2 -translate-x-1/2 text-xs text-foreground/70 tracking-wide font-medium">
					<span class="font-mono text-[10px] text-foreground/45">[nor.]</span> alert
				</sub>
			</h1>
		</div>
...
<style>
	:global(:root) {
		--logo-gradient-start: #dbdcdc;
		--logo-gradient-end: #ffffff;
		--logo-stroke-color: #dbdcdc;
	}

	:global(.dark) {
		--logo-gradient-start: #25282E;
		--logo-gradient-end: #0B0D0F;
		--logo-stroke-color: #25282E;
	}
</style>
