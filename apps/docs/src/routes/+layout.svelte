...
const siteName = "Varsel";
const authorName = "Marek Jóźwiak";
const homeTitle = `${siteName} — Svelte-native toast system`;
const homeDescription =
	"Varsel ships a flexible, headless toaster inspired by Sonner with first-class support for every SvelteKit project.";
const homeKeywords = [
	"varsel",
	"svelte",
	"sveltekit",
...
<svelte:head>
	...
	{#if isHomeRoute}
		...
		<meta property="og:image:alt" content="Varsel logomark" />
		...
		<script type="application/ld+json">
			{JSON.stringify({
				...
				name: siteName,
				alternateName: "Varsel notifications",
				url: canonicalUrl,
